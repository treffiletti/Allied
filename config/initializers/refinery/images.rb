Refinery::Images.configure do |config|
  ...
  config.max_image_size = 10242880
  ...
  # config.dragonfly_secret = "98694c4415b95e35dcb9de45d87e9a5ed3396e4c8829ed20"
  # If you decide to trust file extensions replace :ext below with :format
  # config.dragonfly_url_format = "/system/images/:job/:basename.:ext"
  # config.datastore_root_path = "/Users/trefMac/Sites/allied/allied_app/public/system/refinery/images"
